...
export const LogoSlider = ({
    ...
    return (
        <div
            className={cn(
                "logo-slider w-full overflow-hidden py-8",
                className
            )}
            style={
                {
            ...
            >
                ...
                <ul className="logo-slider__track flex items-center h-full w-fit m-0 p-0 list-none">
                    {[...logos, ...logos].map((logo, index) => (
                        ...
                        >
                            <div className="w-full h-full flex items-center justify-center [&>svg]:h-[65%] [&>svg]:w-auto [&>svg]:fill-zinc-800 [&>img]:h-[65%] [&>img]:w-auto [&>img]:object-contain">
                                {logo}
                            </div>
                        </li>
                    ))}
